<div class="sidebar-header">
    ...
    <div>
            <a href="{{ route('admin.dashboard') }}">
             <h4 class="logo-text">Tc Interiors</h4>
           </a>
    </div>
...
<ul class="metismenu" id="menu">
    ...
    <li>
        ...
        <ul>
            <li> <a href="{{ route('brand.create') }}"><i class="bx bx-right-arrow-alt"></i>Create</a>
            </li>
            {{-- <li> <a href="{{ route('student.edit') }}"><i class="bx bx-right-arrow-alt"></i>Edit</a>
            </li>--}}
            <li> <a href="{{ route('brand.list') }}"><i class="bx bx-right-arrow-alt"></i>Listing</a>
            </li>
            {{-- <li> <a href="app-contact-list.html"><i class="bx bx-right-arrow-alt"></i>Contatcs</a>
            </li>
            <li> <a href="app-to-do.html"><i class="bx bx-right-arrow-alt"></i>Todo List</a>
