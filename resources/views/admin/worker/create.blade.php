    ...
    <div class="page-content">
      <div class="row">
        <div class="col-xl-8 mx-auto">
            <h6 class="mb-0 text-uppercase">Worker Form Details</h6>
            <hr />
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Worker Registration</h5>
                    </div>
                    <hr>
                    <form id="createWorkerForm" enctype="multipart/form-data" class="row g-3">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <img id="showImage" src="{{ (!empty($worker->profile_image)) ? url('upload/student_upload/',$worker->profile_image) : url('upload/No_Image_Available.jpg') }}" alt="worker"  style="height:100px; width:100px;">
                        </div>
                        <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        $('#createWorkerForm').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    alert('Error creating worker. Please check the form and try again.');
                }
            });
        });
    });
